...
import { Home, Scale, Package, CreditCard, History, LogOut } from "lucide-react"
...
export function BottomNavigation({ userType }: NavigationProps) {
...
export function SidebarNavigation({ userType }: NavigationProps) {
  const pathname = usePathname()
  const navItems = userType === "bank-sampah" ? bankSampahNavItems : nasabahNavItems
